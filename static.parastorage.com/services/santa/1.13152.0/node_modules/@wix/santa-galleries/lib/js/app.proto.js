    ...
    switch (linkType) {
        ...
        case 'ANCHOR':
            if (anchorData === "SCROLL_TO_TOP" || anchorData === "SCROLL_TO_BOTTOM") {
                ...
                Wix.pushState(JSON.stringify({
                    cmd: 'navigateToAnchor',
                    args: [pageId, anchorData]
                }));
            }
            break;
        case 'DYNAMIC_PAGE_LINK':
            Wix.pushState(JSON.stringify({
                cmd: 'navigateToDynamicPage',
                args: [renderedLink, anchorData, href]
            }));
            break;
        case 'WEBSITE':
            if (!target) {
...
SimpleAppProto.prototype.override = function(key, value) {
    ...
    this.updateSettings({
        ...
        props: _.extend(_.clone(this.props), data)
    })
}