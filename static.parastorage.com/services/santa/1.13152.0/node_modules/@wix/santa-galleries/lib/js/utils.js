(function(SCOPE) {
    ...
    module.exports.hexToRgba = function(hexColor, opacity) {
        if (!hexColor) return;
        var resultColor, color = (hexColor.charAt(0) == '#') ? hexColor.slice(1) : hexColor,
    ...
    module.exports.getResizedImageUrl = function(relativeUrl, targetWidth, targetHeight, params) {
        ...
        var widthWithPar = targetWidth * PAR,
            heightWithPar = targetHeight * PAR;
    ...
    module.exports.loadGoogleFontIfNeeded = function(propsFont) {
        ...
        Wix.Styles.getEditorFonts(function(fonts) {
            ...
            fonts.forEach(function(fontObj) {
                selected = _.find(fontObj.fonts, {
                    fontFamily: propsFont,
                    provider: 'google'
                })
            });
            if (selected) {
    ...
    module.exports.insertCssRule = function(self, rule) {
        if (!self.tmpStyleSheet) {
            ...
            self.tmpStyleSheet = _.find(document.styleSheets, function(sheet) {
                return sheet.ownerNode === dynamicStyleNode
            })
