    ...
    return function() {
        var e, t, n = {
                ...
                263: function(e, t, n) {
                            ...
                            function t(t) {
                                ...
                                if (I.sentry = null, I.errorMonitor = null, null == d ? void 0 : d.sentryMonitor) I.sentry = null == d ? void 0 : d.sentryMonitor;
                                    ...
                                    if (o.errorMonitor && (null == r ? void 0 : r.essentials.createErrorMonitor)) I.errorMonitor = null == r ? void 0 : r.essentials.createErrorMonitor({
                                        ...
                                        version: "743fbbd3c9dafe0171d04c6f17be76f933ef6b3a1db0204d8ef3ad2a",
                                        tags: {
                                            isSSR: E(i),
                                            isSEO: w(i)
                                        }
                                        ...
                                        var B = m({
                                            dsn: o.DSN,
                                            environment: "Viewer:Worker",
                                            artifact: "743fbbd3c9dafe0171d04c6f17be76f933ef6b3a1db0204d8ef3ad2a",
                                            withDataCallback: !0,
                                            tags: {
                                                isSSR: E(i),
                                                isSEO: w(i)
                    ...
                    function J(e, t) {
                        var n, r, o;
                        this.controllerConfig.wixCodeApi.window.openModal((n = this.componentName || "", r = e, o = this.controllerConfig.appParams.instance, "https://editor.wixapps.net/render/prod/modals/forms-viewer/743fbbd3c9dafe0171d04c6f17be76f933ef6b3a1db0204d8ef3ad2a/" + n + "/" + r + "?instance=" + o), t)
                    }
                    ...
                    var Qt, en, tn, nn, rn, on, an, sn = function(e) {
                        ...
                        wr = function() {
                            return "743fbbd3c9dafe0171d04c6f17be76f933ef6b3a1db0204d8ef3ad2a".replace("-SNAPSHOT", "")
                        },
                        Sr = function(e) {
                            ...
                            ke().forEach(t, (function(e) {
                                ...
                                a && (e.value = a.toString()), e.onCustomValidation((function(t, r) {
                                    if (e.required || !ke().isEmpty(t)) {
                                        var o = ke().toNumber(t);
                                        if (Ar.isEnabled("specs.crm.FormsViewerPaymentsVerboseContent"))
                                        ...
                                        else if (ke().isNaN(o)) r(Ar.t("paymentField.invalidFormat"));
                                        else {
                                            var c = ke().toNumber(ke().get(i, "min") || 0),
                                                u = ke().toNumber(ke().get(i, "max") || Number.MAX_SAFE_INTEGER);
                                            (o < c || o > u) && r(Ar.t("paymentField.outOfRange"))
                                        }
                                    }
                                }))
                            }))
        ...
        }, o.p = "https://static.parastorage.com/services/forms-viewer/743fbbd3c9dafe0171d04c6f17be76f933ef6b3a1db0204d8ef3ad2a/", o(263)
    }()
}));
//# sourceMappingURL=viewerScript.bundle.min.js.map
//# sourceURL=https://static.parastorage.com/services/forms-viewer/1.860.0/viewerScript.bundle.min.js