! function(e, t) {
    ...
    return function() {
        ...
        }, r.p = "https://static.parastorage.com/services/editor-elements-library/dist/thunderbolt/";
        var o = {};
        return function() {
            "use strict";
            r.r(o), r.d(o, {
            ...
            const c = (...e) => e.map((e => e ? `wixui-${e}` : "")).join(" ");
            var u = {
                root: "google-map"
            };
            const d = e => e.replace(/([A-Z])/g, (e => `-${e.toLowerCase()}`)),
                ...
                })(["experiments", "isConsentPolicyActive"], (e => {
                    let {
                        experiments: t,
                        isConsentPolicyActive: n
                    } = e;
            ...
            function I(e, t, r) {
                    ...
                    [Y, ee] = function(e) {
                        ...
                        const o = (0, n.useRef)([]),
                            ...
                            c = (0, n.useCallback)(((e, t) => {
                                if (a.current && r || null != t && t.forceSend) {
                                    var n;
                                    const t = null == (n = a.current) ? void 0 : n.contentWindow;
                                    return void(null == t || t.postMessage(e, "*"))
                                }
                                if (!a.current || !s.current || !1 === r) return void o.current.push(e);
                                const i = a.current.contentWindow;
                                null == i || i.postMessage(e, "*")
                            }), [r]),
                            u = (0, n.useCallback)((() => {
                                0 !== o.current.length && !1 !== r && (o.current.forEach((e => c(e))), o.current = [])
                            }), [c, r]),
                            d = (0, n.useCallback)((e => {
                        ...
                        reducer: (e, t) => {
                            var n;
                            return null == (n = X[e.type]) ? void 0 : n.call(X, {
                                event: e,
                                _sendMessage: t
                            })
                        },
                ...
                return (0, n.useImperativeHandle)(e, (() => ({
                    ...
                    setMarkers: (e, t) => {
                        const n = G();
                        return p.current = e, ee(JSON.stringify({ ...$,
                            locations: g(e),
                    ...
                    if (!V || !a) return;
                    const e = !!q && (t = $.locations, n = q.locations, t.length === n.length && t.every(((e, t) => {
                        const r = Object.keys(e);
                        return r.length === Object.keys(n[t]).length && r.every((r => "locationLinkAttributes" === r || e[r] === n[t][r]))
                    })));
                    var t, n;
                    ee(JSON.stringify({ ...$,
            ...
            const A = {
                GoogleMapLiftedShadow: () => n.createElement(n.Fragment, null, n.createElement("div", {
                    className: s(L.left, L.shd)
                }), n.createElement("div", {
                    className: s(L.right, L.shd)
                })),
                GoogleMapSloppy: () => n.createElement(n.Fragment, null, n.createElement("div", {
                    className: s(L.brd, L.one)
                }), n.createElement("div", {
                    className: s(L.brd, L.two)
                })),
                GoogleMapSkin: () => n.createElement(n.Fragment, null),
                GoogleMapDefault: () => n.createElement(n.Fragment, null)
            };
            var j = r.p + "media/googleMap.ea5928de.html",
                T = r.p + "media/google-map.min.78e15006.js";
            const U = e => e.replace("https://static.parastorage.com/services/", "https://editor.wix.com/_partials/"),
                W = (e, r) => {
                    const {
                        id: o,
                        className: a,
                        ...
                        return i() && r.append("origin", window.origin), (t ? U(j) : j) + "?" + e + "&" + r
                    })(f, S), [k, N] = n.useState(!1), [x] = I(r, {
                        mapData: m,
                        isEditorMode: w
                    }, {
                        onUpdateCenter: y,
                    ...
                    const P = g.title,
                        R = ((e, t) => e ? {} : t)(v, {
                            id: o,
                            className: s(L[p], L.wixIframe, a, c(u.root, ...d)),
                            ...l(e)
                        });
                    return n.createElement("div", t()({}, R, {
                        ...
                        "aria-label": P,
                        "data-src": _
                    }, n.createElement(O, null), n.createElement("div", {
                        id: "mapContainer_" + o,
                        onMouseEnter: b,
                        onMouseLeave: C,
                        className: L.mapContainer
                            ...
                            const r = (e => ({ ...e,
                                updateStyles: t => {
                                    const n = Object.entries(t).reduce(((e, [t, n]) => {
                                        return { ...e,
                                            [(r = t, r.startsWith("--") ? t : d(t))]: void 0 === n ? null : n
                                        };
                                        var r
                                    }), {});
                                    e.updateStyles(n)
